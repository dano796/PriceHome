    ...
    <nav className="bg-red-900 mb-20 py-6">
      <div className="container mx-auto flex items-center justify-between px-8">
        ...
        <div className="flex gap-4 font-medium">
          <a href="#home" className="hover:underline text-[17px] text-neutral-100 pr-1">Home</a>
          <a href="#about" className="hover:underline text-[17px] text-neutral-100 pl-1">About Us</a>
        </div>
